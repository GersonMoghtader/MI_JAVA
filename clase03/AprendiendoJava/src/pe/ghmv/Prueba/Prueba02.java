...
package pe.ghmv.Prueba;

import pe.ghmv.model.Clase1;
import pe.ghmv.model.Clase2;
import pe.ghmv.model.Clase3;
import pe.ghmv.model.Clase4;

public class Prueba02 {
    public static void main(String[] args) {
        Clase2 obj=new Clase2();
        System.out.println("Compatibilidad de in objeto de clase2");
